...
// config for Wuwx/LaravelScanLogin Demo
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'login_success_redirect' => env('SCAN_LOGIN_SUCCESS_REDIRECT', '/demo'),
    ...
    */
    ...
    | Set to false for demo/development environment.
    |
    */
    'require_https' => env('SCAN_LOGIN_REQUIRE_HTTPS', false),
